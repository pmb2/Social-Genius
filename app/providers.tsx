...
import { setupModalOpenHandler, cleanupModalEffects } from '@/lib/modal-handler';
import { cleanupAfterModalClose } from '@/lib/modal-cleanup';

// Import log suppressor to reduce console noise
