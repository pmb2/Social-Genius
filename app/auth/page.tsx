    ...
    <div className="min-h-screen relative flex flex-col">
      ...
      <main className="flex-grow flex items-center justify-center p-4 relative z-10">
        <div className="w-full max-w-5xl flex flex-col md:flex-row rounded-2xl overflow-hidden shadow-lg">
          ...
          <div className="w-full md:w-[600px] relative overflow-hidden min-h-[400px] md:min-h-[600px]">
            <Image
          ...
          <div className="w-full md:flex-1 bg-[#3A0022] p-8 flex flex-col items-center">
            {error && (
              <div className="w-full max-w-md mb-4 px-4 py-3 bg-red-500/20 border border-red-500/30 text-white rounded-lg text-sm">
                {error}
              </div>
            )}
            ...
            {isLogin ? (
              /* Login View */
              <>
                <h2 className="text-white text-4xl font-bold mb-14 text-center whitespace-nowrap">Member Log In</h2>
                ...
                <Link href="#" className="text-white/90 hover:text-white text-sm mt-8">
                ...
                <button
                  onClick={toggleView}
                  className="mt-10 text-white/90 hover:text-white flex items-center group text-base bg-transparent border-none cursor-pointer p-0"
                >
                  <span>Create your Account</span>
                  <span className="ml-2 w-6 h-6 bg-[#FFA726] rounded-full flex items-center justify-center">
              ...
              <>
                ...
                <button
                  onClick={toggleView}
                  className="mt-6 text-white/90 hover:text-white flex items-center group text-base bg-transparent border-none cursor-pointer p-0"
                >
