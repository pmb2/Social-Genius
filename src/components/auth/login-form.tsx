...
export function LoginForm() {
    ...
    return (
        <div className="w-full space-y-6">
            {isInsecure && (
                <div
                    className="flex items-center space-x-2 p-3 bg-red-100 border border-red-400 text-red-800 rounded-md text-sm">
                    <AlertCircle size={16}/>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                {error && (
                    <div
                        className="flex items-center space-x-2 p-3 bg-red-50 border border-red-200 text-red-700 rounded-md text-sm">
                        <AlertCircle size={16}/>
                        <span>{error}</span>
                    </div>
                )}
            ...
            <div className="flex space-x-4">
                <button
                    className="flex-1 flex justify-center items-center h-11 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 transition-colors">
                ...
                <button
                    ...
                    <svg width="18" height="18" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path
                            ...
                            fill="#1877F2"/>
                        <path
                            d="M15.893 14.89l.443-2.89h-2.773v-1.876c0-.79.387-1.562 1.63-1.562h1.26v-2.46s-1.145-.195-2.238-.195c-2.285 0-3.777 1.384-3.777 3.89V12h-2.54v2.89h2.54v6.988C10.925 21.957 11.45 22 12 22s1.075-.043 1.593-.122v-6.988h2.3z"
                            fill="#FFFFFF"/>
                    </svg>
